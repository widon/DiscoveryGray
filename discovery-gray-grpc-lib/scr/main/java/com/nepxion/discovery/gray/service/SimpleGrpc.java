...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.nepxion.discovery.gray.service.HelloRequest,
      com.nepxion.discovery.gray.service.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.nepxion.discovery.gray.service.HelloRequest.class,
      responseType = com.nepxion.discovery.gray.service.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.nepxion.discovery.gray.service.HelloRequest,
      com.nepxion.discovery.gray.service.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.nepxion.discovery.gray.service.HelloRequest, com.nepxion.discovery.gray.service.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.nepxion.discovery.gray.service.HelloRequest, com.nepxion.discovery.gray.service.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Simple", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nepxion.discovery.gray.service.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nepxion.discovery.gray.service.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.nepxion.discovery.gray.service.HelloRequest request,
        io.grpc.stub.StreamObserver<com.nepxion.discovery.gray.service.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.nepxion.discovery.gray.service.HelloRequest,
                com.nepxion.discovery.gray.service.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractStub<SimpleBlockingStub> {
     ...
     * </pre>
     */
    public com.nepxion.discovery.gray.service.HelloReply sayHello(com.nepxion.discovery.gray.service.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractStub<SimpleFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.nepxion.discovery.gray.service.HelloReply> sayHello(
        com.nepxion.discovery.gray.service.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.nepxion.discovery.gray.service.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.nepxion.discovery.gray.service.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.nepxion.discovery.gray.service.Helloworld.getDescriptor();
    }
